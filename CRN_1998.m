function [Vm,state,dv2dt]=CRN_1998(Vm,state,Ie,dv2dt,domain,dt,scalar)
...
if nargin==0
    ...
    % Run model function
    [Vm,h,d,xr,Na_i,K_i,Ca_rel,oi,ui,Ca_i,v,m,j,f,xs,Ca_up,oa,ua,fCa,u,w,dv2dt]=...
...
%% MODEL FUNCTION
    function [Vm,h,d,xr,Na_i,K_i,Ca_rel,oi,ui,Ca_i,v,m,j,f,xs,Ca_up,oa,ua,fCa,u,w,dv2dt]=...
